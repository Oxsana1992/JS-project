...
var _sitebar = require("./classes/sitebar");
var _mainCss = require("./styles/main.css");
const site = new (0, _site.Site)("#site");
site.render((0, _model.model));
const updateCallback = (newBlock)=>{
    (0, _model.model).push(newBlock);
    site.render((0, _model.model));
};
new (0, _sitebar.Sitebar)("#panel");

},{"./model":"dEDha","./styles/main.css":"clPKd","./classes/site":"24VTm","./classes/sitebar":"4iM7m"}],"dEDha":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "model", ()=>model);
var _font2Jpg = require("./assets/font2.jpg");
var _font2JpgDefault = parcelHelpers.interopDefault(_font2Jpg);
...
const model = [
    new (0, _blocks.TitleBlock)("Конструктор сайтов на JS!", {
        tag: "h2",
        styles: {
            background: "linear-gradient(to right, #DE3163, #40E0D0)",
            color: "#fff",
            "text-align": "center",
            padding: "1.5rem"
        }
    }),
    new (0, _blocks.ImageBlock)((0, _font2JpgDefault.default), {
        styles: {
            display: "flex",
    ...
    new (0, _blocks.TextBlock)(textcont, {
        styles: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assets/font2.jpg":"3PSZw","./classes/blocks":"gMfMj"}],"gkKU3":[function(require,module,exports) {
...
},{}],"3PSZw":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "font2.3cfe35bc.jpg" + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4iM7m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Sitebar", ()=>Sitebar);
var _utils = require("../utils");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utils":"en4he","./blocks":"gMfMj"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire5634")
